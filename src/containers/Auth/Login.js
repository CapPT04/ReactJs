...
class Login extends Component {
    ...
    handleLogin = async () => {
        ...
        try {
            let data = await handleLoginApi(this.state.username, this.state.passwork);
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        userLoginSuccess: (userInfo) => dispatch(actions.userLoginSuccess(userInfo)), // Define the 'userInfo' parameter here
    };
};
